                ...
                */
                ...
                if(!$customer_exists)
                {
                    ...
                    if($autoInc_id)
                    {
                        ...
                        $customer_id = "STUDENT-".$cphone.$autoInc_id;
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No Students registered to use a bus!!</h1>
                        <p class="fw-light">Be the first person to add Studets!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> to add a Student!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="customer">
                ...
                <div id="customer-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Add Student Details <i class="fas fa-plus"></i></button>
                    </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="cfirstname" class="form-label">Student Firstname</label>
                                <input type="text" class="form-control" id="cfirstname" name="cfirstname">
                            </div>
                            <div class="mb-3">
                                <label for="clastname" class="form-label">Student Lastname</label>

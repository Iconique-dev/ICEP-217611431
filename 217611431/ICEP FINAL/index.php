...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="https://www.tut.ac.za/" class="nav-item nav-logo">TUT</a>
            ...
            <div>
                ...
                <a href="#pnr-enquiry" class="pnr nav-item"><i class="fas fa-file-export"></i>DOWNLOAD TICKET</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Tshwane University of Technology Bus Sit Booking System</h1>

            <p class="text-center">Welcome to Tshwane University of Technology Bus Sit System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
            ...
            <br>
             <center>
               <a href="studentBooking.php"> <button class="btn btn-danger "  >BOOK A SIT</button></a>
    ...
    <div id="block">
        <section id="info-num">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <span class="icon-name">happy Students</span>
                </figcaption>
            </figure>
            <figure>
                ...
                <figcaption>
                    ...
                    <span class="icon-name">Instant Sit Reserv</span>
                </figcaption>
            </figure>
        </section>
        <section id="pnr-enquiry">
            <div id="pnr-form">
                <h2>PNR ENQUIRY/RECEIPT</h2>
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Tshwane University Bus SIT Booking System | Made with &#10084;&#65039; by Iconique IT Solution
                        </p>
        </footer>
    </div>
